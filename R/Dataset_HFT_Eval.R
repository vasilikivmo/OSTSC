...
#' to 10. In this package, the class 1 and class -1 observations are random selected till 600, while the 
#' class 0 is 28800. While the whole observations are ordered in the time order, the dataset haven't split 
#' training and setting data. The users can split it by any ratio they like.
#'
#' @format A dataset with 30000 observations and 10 sequence length, with a single sequence per row. 
#' \describe{
...
#' @docType data
#' @keywords datasets
#' @name Dataset_HFT_Eval
#' @usage data(Dataset_HFT_Eval)
