#' @title Mobile Health.
#'
#' @description The MHEALTH (Mobile Health) dataset is devised to benchmark techniques dealing with 
#' human behavior analysis based on multimodal body sensing. 
#' @details Comprises body motion and vital signs recordings for ten volunteers of diverse profile 
#' while performing several physical activities. Sensors placed on the subject's chest, right wrist 
...
#'   
#'   In this dataset, for a simple example displaying, only subject 1 and feature 12 (magnetometer 
...
#' @docType data
#' @keywords datasets
#' @name Dataset_MHEALTH_Check
#' @usage data(Dataset_MHEALTH_Check)
